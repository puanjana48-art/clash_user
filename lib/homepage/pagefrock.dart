import 'package:clashproject/homepage/frockdetail1.dart';
import 'package:clashproject/homepage/kurthidetail1.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';
import 'package:firebase_auth/firebase_auth.dart';

class Frocks extends StatefulWidget {
  const Frocks({super.key});

  @override
  State<Frocks> createState() => _FrocksState();
}

class _FrocksState extends State<Frocks> {
          ...
          return GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Padding(
                ...
                child: InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => Frockdetail(category: 'frocks', productId: product.id),));
                  },
                  child: Container(
                                ...
                                Positioned(
                                  ...
                                  child: StreamBuilder<QuerySnapshot>(
                                    stream: FirebaseFirestore.instance
                                        ...
                                        .where('category', isEqualTo: 'frocks')
                                        .snapshots(),
                                    builder: (context, snapshot) {
