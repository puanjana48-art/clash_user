import 'package:clashproject/homepage/Topdetail1.dart';
          ...
          return GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Padding(
                ...
                child: InkWell(
                  onTap: (){
                   Navigator.push(context, MaterialPageRoute(builder: (context) => Topdetail(category: 'womentop', productId: product.id)));
                  },
                  child: Container(
                                ...
                                Positioned(
                                  ...
                                  child: StreamBuilder<QuerySnapshot>(
                                    stream: FirebaseFirestore.instance
                                        ...
                                        .where('category', isEqualTo: 'womentop')
                                        .snapshots(),
                                    builder: (context, snapshot) {
